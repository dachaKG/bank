...
public class WebServiceConfig extends WsConfigurerAdapter{
	...
	public CommonsXsdSchemaCollection schemeCollection() {
		CommonsXsdSchemaCollection collection =
				new CommonsXsdSchemaCollection(new Resource[] { new ClassPathResource("/ZahtevZaDobijanjeIzvoda.xsd"), new ClassPathResource("/strukturaRtgsNaloga.xsd")});
      ...
      marshaller.setContextPath("localhost._8080.ws.nalogzaplacanje");
